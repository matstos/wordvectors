...
vocab_size=50250 # the maximum vocabulary size
...
wget "https://dumps.wikimedia.org/${lcode}wiki/20171103/${lcode}wiki-20171103-pages-articles-multistream.xml.bz2"

echo "step 2. Extract the bz2 file."
bzip2 -d "${lcode}wiki-20171103-pages-articles-multistream.xml.bz2"
